...
export const metadata: Metadata = {
  ...
  title: {
    default: "GAMVORA — Top Up Game Tanpa Password",
    template: "%s — GAMVORA",
  },
  ...
  openGraph: {
    ...
    siteName: site.name,
    locale: site.locale,
    title: "GAMVORA — Top Up Game Tanpa Password",
    description: site.shortDescription,
    url: site.url,
    images: [{ url: site.ogImage, width: 1200, height: 630, alt: "GAMVORA — Top Up Game Tanpa Password" }],
  },
  twitter: {

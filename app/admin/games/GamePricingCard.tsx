              ...
              {editing === item.id ? (
                <>
                  ...
                  <button
                    ...
                    disabled={loading}
                    className="shrink-0 w-9 h-9 flex items-center justify-center rounded-lg bg-raise text-grey hover:text-paper hover:bg-line transition disabled:opacity-50"
                    title="Batal"
                  >
                ...
                <>
                  ...
                  <button
                    ...
                    disabled={loading}
                    className="shrink-0 w-9 h-9 flex items-center justify-center rounded-lg bg-raise text-grey hover:text-accent hover:bg-accent/10 transition disabled:opacity-50"
                    title="Edit"
                  >
                  ...
                  <button
                    ...
                    disabled={loading}
                    className="shrink-0 w-9 h-9 flex items-center justify-center rounded-lg bg-raise text-grey hover:text-red-500 hover:bg-red-50 transition disabled:opacity-50"
                    title="Hapus"
                  >
